...
lane close with no further write. Every reader of a finished state reaches that
one arithmetic, the audit's terminal precondition among them, and nothing writes
a parent's finished state.
