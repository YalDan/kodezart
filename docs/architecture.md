...
| CIMonitor         | GitHubAPIClient          | Returns typed completed, absent or incomplete check observations; re-observes Actions attempts at one commit |
...
The native graph of `RalphWorkflowEngine` uses the same execution,
