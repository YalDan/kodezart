...
async def test_a_scoped_walk_finishes_every_criterion_at_its_head_with_a_record():
    ...
    for lane in ("A", "B"):
        ...
        # lane's own account of the criterion it finished, keyed to it and
        # carrying the head it was graded at.
        ...
        assert [
            ...
            (RunEventKind.ISSUE_CROSSED_OFF, own_head),
        ]
        ...
        assert stream[2].subject_key == f"{lane}/check"
    ...
    # One record, one first-push event, one session opening and one
    # crossing-off per lane, and nothing else.
