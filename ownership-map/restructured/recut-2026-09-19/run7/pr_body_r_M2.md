...
`44bacf63c6f475eda29bedf2109ae03f71901ba2` by **symbol-level ownership**: every file whose file-level owner is M2 arrives
...
### Re-derived file counts (`git diff --name-status origin/v03/m3-plan-walk...6caa3c44`)
| | count |
|---|---|
