...
`9d425ec4b2697fa8032e1f92287fb03b82d8603a` by **symbol-level ownership**: every file whose file-level owner is M3 arrives
...
### Re-derived file counts (`git diff --name-status origin/v03/m4-criterion-lifecycle...4a5146e7`)
| | count |
|---|---|
| files changed vs `v03/m4-criterion-lifecycle` | 143 |
| added | 78 |
| modified | 65 |
| deleted | 0 |
| renamed | 0 |

Cut composition at this milestone: 124 whole union files, 20 shared files
...
Syntax check (`ast.parse`) on every Python file this view changes against its parent: **135 files, all parse**.
