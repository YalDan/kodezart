...
`9d425ec4b2697fa8032e1f92287fb03b82d8603a` by **symbol-level ownership**: every file whose file-level owner is M6 arrives
...
### Re-derived file counts (`git diff --name-status origin/v03/m5-deliver-terminate...3a23e284`)
| | count |
|---|---|
...
Cut composition at this milestone: 90 whole union files, 7 shared files
