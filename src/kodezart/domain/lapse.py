...
def graded_state(
    ...
    *base_stale* is a reading, not a comparison of this rule's own: it is
    what :func:`kodezart.domain.base_staleness.is_base_stale` answered for
    the base this grading was dispatched on, handed in by the caller that
