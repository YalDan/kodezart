    ...
    return scheduled + [
        ScheduledPass(
            ...
            run=partial(
                ...
                # server this deployment attaches to scheduled passes, and a
                # list naming the in-process tools would read as the whole
                # set a pass may use while saying nothing about the ones it
                # exists to call.
                allowed_tools=[],
                skills=skills,
