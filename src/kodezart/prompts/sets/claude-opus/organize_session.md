...
Escalation is one act: add the label `{{issue_labels.decision}}` to the member, write the question on it, and leave the member as it is. Reserve it for a choice a person has to make that the board does not settle.
