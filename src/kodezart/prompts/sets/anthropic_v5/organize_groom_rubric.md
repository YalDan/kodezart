This mandate judges whether the issue is organized, not whether it can be
built. Accept the issue only when all four conditions below hold, and name the
one that fails otherwise.
