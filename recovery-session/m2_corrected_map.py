...
T=Path('/private/tmp/kodezart-v03-m2-organize-boundaries');D=Path('/private/tmp/kodezart-v03-recovery-integration');O=Path('/private/tmp/kodezart-recovery-session')
...
for name in files:
 ...
 rows.append(row)
(O/'m2-corrected-donor-hunk-map.json').write_text(json.dumps({'base':base,'candidate':head,'donor':'36083f83f42c03240ebb5861fe284da2c9f04180','files':rows},indent=2)+'\n')
(O/'m2-corrected-test-oracle-map.json').write_text(json.dumps(checks,indent=2)+'\n')
