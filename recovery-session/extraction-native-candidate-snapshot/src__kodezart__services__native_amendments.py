...
from kodezart.domain.errors import CriterionReadError, RulingRecordReadError, ScopeReadError
        ...
        *,
        ...
        for expected, current_issue in zip(
            ...
            try:
                ...
                raise NativeWriteRefusalError("Current Checks or native criterion facts changed during writing") from exc
