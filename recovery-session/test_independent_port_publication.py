...
from kodezart.core.errors import (
    McpCallUnansweredError, McpCredentialRefusedError, McpSessionClosedError,
    McpTransportError, RunRecordWriteError,
)
...
@pytest.mark.parametrize('sink_type,system,write_tool', [
...
async def test_real_recorder_publication_is_never_replayed(sink_type, system, write_tool, failure_type, expected):
    ...
    recorder = RunRecorder(records={record.kind.value: destination}, sinks={system: sink})
